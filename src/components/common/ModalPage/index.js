...
class TablePage extends Component {
    ...
    componentWillReceiveProps(props) {
        ...
        const oldQuery = _.pick(this.props.router.query, 'page', 'pSize', 'q', ...this.keys);
        const newQuery = _.pick(props.router.query, 'page', 'pSize', 'q', ...this.keys);
    ...
    search(props, { scrollToTop } = {}) {
        ...
        this.props.onLoadData({
            values: values,
            pageIndex: Number(q && q.page ? q.page : 1) || 1,
            pageSize: Number(q && q.pSize ? q.pSize : 5) || 5,
        });
    ...
    updatePagination = pagination => {
        ...
        this.props.router.setQuery({
            ...
            pSize: pageSize === 5 ? null : pageSize,
        }, { replace: true });
    }
    ...
    render() {
        const { def, data, onLoadData, onResetData, renderFormFields, renderFooter, showSizeChanger = true, ...props} = this.props;
            ...
            <div>
                ...
                <div className='table-box block'>
                    <TableComponent
                        ...
                        footer={ renderFooter ? () => renderFooter(values) : null }
