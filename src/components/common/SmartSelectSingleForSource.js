  ...
  render() {
    ...
    return (
      <Select
        ...
        onSearch={ (value) => this.handleSearch ? this.handleSearch(value) : undefined }
      ...
      >
        { options ? options : this.props.children}
      </Select>
    )
  }
}
...
class SmartSelectSingleAsyncParent extends SmartSelectSingle{
  ...
  componentWillReceiveProps(nextProps) {
    ...
    */
    if(this.props.asyncRequestFuncName !== nextProps.asyncRequestFuncName && nextProps.asyncRequestFuncName){
        this.setState({asyncRequestFuncName: nextProps.asyncRequestFuncName});
        let params = nextProps.asyncRequestParams ? nextProps.asyncRequestParams : {}
        this.props.getAsyncSmartSelectSingleOptinsAction(nextProps.asyncRequestFuncName, this.state.asyncResultId, null, params)
    }
    if(this.state.asyncResultId){
      ...
      if(this.props.smartSelectSingle && this.props.smartSelectSingle[key]
        && this.props.smartSelectSingle[key].status !== nextProps.smartSelectSingle[key].status
        && nextProps.smartSelectSingle[key].status == 'fulfilled'){
...
export const SmartSelectSingleForSource = connect(select, mapDispachToProps)(SmartSelectSingleAsyncParent)
