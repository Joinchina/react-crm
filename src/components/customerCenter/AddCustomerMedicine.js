...
import { Form, InputNumber, Input, AutoComplete, Row, Col, Tag} from 'antd'
...
export default class AddCustomerMedicine extends Component {
  constructor(props) {
    super(props)
    this.state = {
    }
    ...
    return (
      <div className='form-table-box block' id='addCustomerMedicine'>
        <table>
          <thead>
            <tr>
              <th width='30%'> 通用名（商品名）</th>
              <th width='15%'>规格</th>
              <th width='23%'>生产企业</th>
              <th width='24%'>单月用量(盒/瓶，包装单位)</th>
              <th width='8%'>操作</th>
            </tr>
          </thead>
          {formItems}
