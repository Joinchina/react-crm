...
var Overlays = function () {
  ...
  _createClass(Overlays, [{
    ...
    value: function scrollVertically(distance) {
      ...
      if (this.scrollableElement.translateScrollTo) {
        this.scrollableElement.translateScrollTo.scrollTop += distance;
      } else {
    ...
    value: function scrollHorizontally(distance) {
      ...
      if (this.scrollableElement.translateScrollTo) {
        this.scrollableElement.translateScrollTo.scrollLeft += distance;
      } else {
